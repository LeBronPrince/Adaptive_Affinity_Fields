...
def get_arguments():
  ...
  parser.add_argument('--data-list', type=str, default='/home/wangyang/Desktop/Semantic Segmentation Code/MENet/data/voc12/train.txt',
  ...
  # Misc paramters
  parser.add_argument('--restore-from', type=str, default='/home/wangyang/Desktop/Semantic Segmentation Code/Adaptive_Affinity_Fields/resnet_v1_101.ckpt',
  ...
  parser.add_argument('--snapshot-dir', type=str, default='/home/wangyang/Desktop/Semantic Segmentation Code/Adaptive_Affinity_Fields/snapshot',
