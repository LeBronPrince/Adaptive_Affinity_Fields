...
IMG_MEAN_ndsm = np.array((122.675, 116.669, 104.008, 30.7), dtype=np.float32)
...
def get_arguments():
  ...
  parser.add_argument('--data-list', type=str, default='/home/f523/wangyang/segmentation/Adaptive_Affinity_Fields/dataset/Vaihingen/Vaihingen_test_ndsm_hist.txt',
  ...
  parser.add_argument('--restore-from', type=str, default='/home/f523/wangyang/segmentation/Adaptive_Affinity_Fields/snapshot/snapshot_v9_ndsm_hist/model.ckpt-7000',
                      help='Where restore model parameters from.')#'/home/f523/guazai/sda/wangyang/segmentation/snapshot_psp_pos/model.ckpt-10000'
  parser.add_argument('--save-dir', type=str, default='/home/f523/wangyang/segmentation/Adaptive_Affinity_Fields/inference/inference_v9_ndsm',
...
def main():
  ...
  crop_image_batch = tf.placeholder(
      ...
      shape=[1,input_size[0],input_size[1],4],
      dtype=tf.float32)
  ...
  for step in range(num_steps):
    ...
    color = general.decode_labels_inference(lab_batch)
